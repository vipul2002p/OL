...
var src = fs.readdirSync('C:/Users/Admin/Documents/Ol/Ol/backend/public/uploads/');
...
app.post("/uploads",(req,res) => {
    console.log("come in uploads post req");
     ...
     form.parse(req,(err,fields,files) => {
        ...
        fs.rename(oldpath,"C:/Users/Admin/Documents/Ol/Ol/backend/public/uploads/"+`${files.photo[0].originalFilename}`,(err) => {
            if(err){
                console.log(err);
            }
        })
